    ...
    wayland.windowManager.hyprland = {
        ...
        settings = {
            ...
            bind = [
                ...
                { _args = [ "XF86MonBrightnessDown" (lib.generators.mkLuaInline "hl.dsp.exec_cmd('brightnessctl set 10%-')") { locked = true; } ]; }
                { _args = [ "XF86MonBrightnessUp" (lib.generators.mkLuaInline "hl.dsp.exec_cmd('brightnessctl set 10%+')") { locked = true; } ]; }
